...
//! `typed-routing` | Enables the [`TypedPath`](crate::routing::TypedPath), [`TypedMethod`](crate::routing::TypedMethod), and typed routing utilities along with the `routing` feature. |
