...
{
    serve_with_connection_builder(listener, Hyper::default(), make_service)
}
...
/// # };
/// ```
pub fn serve_with_connection_builder<L, C, M, S, B>(
    listener: L,
...
mod tests {
    ...
    use crate::{
        ...
        routing::get,
        serve::{serve_with_connection_builder, Connection, ConnectionBuilder, ListenerExt},
        Router, ServiceExt,
    };
    ...
    async fn serving_without_hyper() {
        ...
        tokio::spawn(serve_with_connection_builder(listener, OkGenerator, app).into_future());
